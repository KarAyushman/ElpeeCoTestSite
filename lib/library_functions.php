...
function sendEmail($use_template,$heading,$messagebody,$footer,$mail_type,$to_mail,$subject,$filename,$filepath)
{
...
$mail->Host = "hubertozz.com"; //changed localhost/smtp.gmail.com for using godaddy
$mail->Port = 25; //587 tls , 463 ssl , 25 unsecured //Comment if using Godaddy
$mail->IsHTML(true);
$mail->Username = "orders@hubertozz.com"; //Comment if using Godaddy
$mail->Password = "Orders123"; //Comment if using Godaddy
...
$mail->SMTPAuth = true;
$mail->Username = "info@lifesenz.co.in";
$mail->Password = "LifeSe@123";
...
// Sender info
$mail->setFrom('info@lifesenz.co.in', 'lifesenz');
...
$mail->AddAddress($to_mail);
$mail->addAttachment($filename,$filepath); 
